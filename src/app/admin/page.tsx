      ...
      <CardContent className="p-6">
        ...
        {change !== undefined && !loading && (
          ...
          >
            ...
            <span>
              {positive ? "+" : ""}
              {typeof change === "number" ? change.toFixed(1) : change}% from
              previous period
            </span>
          </div>
        )}
...
const AdminDashboardPage = () => {
  ...
  const projectDistributionData = data?.dashboardData
    ? [
        {
          name: "Published",
          value: data.dashboardData.projectStats.publishedProjects,
        },
        {
          name: "Unpublished",
          value:
            data.dashboardData.projectStats.totalProjects -
            data.dashboardData.projectStats.publishedProjects,
        },
      ]
    : [];
  ...
  const collaborationDistributionData = data?.dashboardData
    ? [
        {
          name: "Accepted",
          value: data.dashboardData.collaborationStats.acceptedRequests,
        },
        {
          name: "Pending",
          value: data.dashboardData.collaborationStats.pendingRequests,
        },
        {
          name: "Rejected",
          value:
            data.dashboardData.collaborationStats.totalRequests -
            data.dashboardData.collaborationStats.acceptedRequests -
            data.dashboardData.collaborationStats.pendingRequests,
        },
      ]
    : [];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <StatCard
            ...
            icon={Code2}
            positive={
              data?.dashboardData?.projectStats.projectGrowth?.monthly >= 0
            }
            loading={isLoading}
          />
        </motion.div>
        ...
        >
          <StatCard
            ...
            change={data?.dashboardData?.collaborationStats.acceptanceRate?.toFixed(
              1
            )}
            icon={Database}
            positive={true}
                ...
                <>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-medium">
                      {data?.dashboardData?.feedbackStats.totalFeedback}
                    </span>
                  </div>
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-sm text-muted-foreground">
                    ...
                    <span className="font-medium">
                      {data?.dashboardData?.feedbackStats.unprocessedFeedback}
                    </span>
                  </div>
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-sm text-muted-foreground">
                    ...
                    <span className="font-medium">
                      {data?.dashboardData?.feedbackStats.processingRate?.toFixed(
                        1
                      )}
                      %
                    </span>
